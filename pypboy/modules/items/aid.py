...
class Module(pypboy.SubModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.icons = Icons()
        self.icons.image = pygame.image.load('images/Aid/misc.png')
        self.icons.rect[0] = 245
        self.icons.rect[1] = 185
        self.add(self.icons)
        self.items = Items()
        self.items.image = pygame.image.load('images/Aid/test.png')
        self.items.rect[0] = 215
        self.items.rect[1] = 50
        self.add(self.items)
        self.menu = pypboy.ui.Menu(200, ['{: <23}'.format("Programmer's Digest"),
                                         '{: <23}'.format("Mentats (3)"),
                                         '{: <23}'.format("Rad-X (2)"),
                                         '{: <23}'.format("RadAway"),
                                         '{: <23}'.format("Some Food"),
    ...
    def rect1(self):
        self.builder("----", 20, Effects="Science +10(for 60 seconds)", IMG='images/Aid/Icon_Programmers_Digest.png')

    def rect2(self):
        self.builder("----", 5, Effects="PER +5, INT +5", IMG='images/Aid/Icon_Mentats.png')

    def rect3(self):
        self.builder("----", 10, Effects="Rad. Res. +42", IMG='images/Aid/Icon_Rad-X.png')

    def rect4(self):
        self.builder("----", 15, Effects="Rads -84", IMG='images/Aid/Icon_RadAway.png')

    def rect5(self):
        self.builder(1, 15, Effects="Rads +2, HP +6", IMG='images/Aid/Icon_caravan_lunch.png')

    def rect6(self):
        self.builder(1, 25, Effects="Rads +2, HP +12", IMG='images/Aid/Icon_cola.png')

    def rect7(self):
        self.builder(1, 15, Effects="HP +20", IMG='images/Aid/Icon_water.png')

    def builder(self, WG, VAL, DAM_DT=None, DAM_DT_VAL=None, CND=None, Descript=None, Descript2=None, Effects=None, STR=None, MOD=None, REPAIR=None, MAINTAIN=None, IMG='images/Aid/test.png', ICON=None, ICON_DESCR=None):
