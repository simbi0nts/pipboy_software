...
class Module(pypboy.SubModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.icons = Icons()
        self.icons.image = pygame.image.load('images/Apparel/misc.png')
        self.icons.rect[0] = 245
        self.icons.rect[1] = 185
        self.add(self.icons)
        self.items = Items()
        self.items.image = pygame.image.load('images/Apparel/test.png')
        self.items.rect[0] = 215
        self.items.rect[1] = 50
        self.add(self.items)
        self.menu = pypboy.ui.Menu(200, ['{: <23}'.format("Glasses"),
                                         '{: <23}'.format("Shabby Clothes")], [self.rect1, self.rect2], 0)
        self.menu.rect[0] = 18
        self.menu.rect[1] = 60
        self.add(self.menu)

    def rect1(self):
        self.builder(1, 2, DAM_DT="DR", CND=12, DAM_DT_VAL="1", REPAIR="Y", MAINTAIN="Y", IMG='images/Apparel/Icon_glasses.png')

    def rect2(self):
        self.builder(3, 5, DAM_DT="DR", CND=13, DAM_DT_VAL="2", REPAIR="Y", MAINTAIN="Y", Effects="AGL -1", IMG='images/Apparel/Icon_Ulysses_duster.png')

    def builder(self, WG, VAL, DAM_DT=None, DAM_DT_VAL=None, CND=None, Descript=None, Descript2=None, Effects=None, STR=None, MOD=None, REPAIR=None, MAINTAIN=None, IMG='images/Apparel/test.png', ICON=None, ICON_DESCR=None):
