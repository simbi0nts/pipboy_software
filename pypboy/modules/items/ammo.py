...
class Module(pypboy.SubModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.icons = Icons()
        self.icons.image = pygame.image.load('images/AMMO/misc.png')
        self.icons.rect[0] = 245
        self.icons.rect[1] = 185
        self.add(self.icons)
        self.items = Items()
        self.items.image = pygame.image.load('images/AMMO/test.png')
        self.items.rect[0] = 215
        self.items.rect[1] = 50
        self.add(self.items)
        self.menu = pypboy.ui.Menu(200, ['{: <23}'.format("Prop Ammo (26)"),
                                         '{: <23}'.format("Another Prop Ammo (6)"),],
                                   [self.rect1, self.rect2,], 0)
        self.menu.rect[0] = 18
        self.menu.rect[1] = 60
        self.add(self.menu)

    def rect1(self):
        self.builder('-- --', 3, IMG="images/AMMO/45-70_Gov't_icon.png")

    def rect2(self):
        self.builder('-- --', 2, IMG='images/AMMO/FNV_9mm_ammo_icon.png')

    def builder(self, WG, VAL, DAM_DT=None, DAM_DT_VAL=None, CND=None, Descript=None, Descript2=None, Effects=None, STR=None, MOD=None, REPAIR=None, MAINTAIN=None, IMG='images/AMMO/test.png', ICON=None, ICON_DESCR=None):
