...
class GalaxyNewsRadio(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/new2/'
        super(GalaxyNewsRadio, self).__init__(self, *args, **kwargs)

class NewVegasRadio(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/new/'
        super(NewVegasRadio, self).__init__(self, *args, **kwargs)
...
class RadioLostSouls(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/radiols/'
        super(RadioLostSouls, self).__init__(self, *args, **kwargs)

class RadioDustEars(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/radiode/'
        super(RadioDustEars, self).__init__(self, *args, **kwargs)

class RadioSilentWasteland(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/radiosw/'
        super(RadioSilentWasteland, self).__init__(self, *args, **kwargs)

class MotivatingSongsRadio(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/msr/'
        super(MotivatingSongsRadio, self).__init__(self, *args, **kwargs)

class StopRadio(RadioStation):
    def __init__(self, *args, **kwargs):
        self.directory = 'sounds/radio/stp/'
        super(StopRadio, self).__init__(self, *args, **kwargs)